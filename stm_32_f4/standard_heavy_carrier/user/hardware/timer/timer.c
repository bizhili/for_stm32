...
void bsp_Inittimer7(void)
{
TIM_TimeBaseInitTypeDef TIM_TimeBaseInitStrecture;
NVIC_InitTypeDef NVIC_InitStructure;
RCC_APB2PeriphClockCmd(RCC_APB1Periph_TIM7,ENABLE);/*使能定时器1的时钟*/


NVIC_InitStructure.NVIC_IRQChannel = TIM7_IRQn;/*定时器1的中断通道使能*/
...
TIM_TimeBaseInitStrecture.TIM_Period = 1000-1;/*重装载寄存器*/
TIM_TimeBaseInitStrecture.TIM_Prescaler = 180-1;/*预分配*/
...
TIM_TimeBaseInit(TIM7,&TIM_TimeBaseInitStrecture);/*初始化*/

//TIM_ClearFlag(TIM4,TIM_FLAG_Update);/*清更新标志位*/
